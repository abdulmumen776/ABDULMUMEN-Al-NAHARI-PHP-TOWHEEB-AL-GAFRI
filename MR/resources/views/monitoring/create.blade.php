...
@section('header')
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-bold text-gradient mb-2">إضافة مراقبة جديدة</h2>
            <p class="text-gray-600 dark:text-gray-400">إعداد جلسة مراقبة جديدة للكاميرات والأماكن</p>
        </div>
...
@section('content')
    <div x-data="monitoringForm()" x-init="init()" x-cloak>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">اختيار الكاميرات</h3>
                        <p class="text-xs text-gray-400 dark:text-gray-500">تحديد الكاميرات</p>
                    </div>
                </div>
                <div class="flex-1 mx-8">
        ...
        <!-- Form Section -->
        <div class="card p-8">
            <form action="{{ route('monitoring.store') }}" method="POST" @submit.prevent="submitForm">
                @csrf
                                ...
                                <div class="bg-white bg-opacity-20 rounded-lg p-4">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-blue-100">جلسة مراقبة جديدة</p>
                                        </div>
                                    </div>
                                    <div class="space-y-2">
                ...
                <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button type="submit" :disabled="loading" class="btn btn-primary">
                            <span x-show="!loading">بدء المراقبة</span>
