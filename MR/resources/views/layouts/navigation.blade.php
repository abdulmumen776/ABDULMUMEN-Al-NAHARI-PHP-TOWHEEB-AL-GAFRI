<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('apis.index')" :active="request()->routeIs('apis.*')">
                        الـ APIs
                    </x-nav-link>
                    <x-nav-link :href="route('dashboards.index')" :active="request()->routeIs('dashboards.*')">
                        لوحات التحكم
                    </x-nav-link>
                    <x-nav-link :href="route('performance-metrics.index')" :active="request()->routeIs('performance-metrics.*')">
                        المقاييس
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('apis.index')" :active="request()->routeIs('apis.*')">
                الـ APIs
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('dashboards.index')" :active="request()->routeIs('dashboards.*')">
                لوحات التحكم
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('performance-metrics.index')" :active="request()->routeIs('performance-metrics.*')">
                المقاييس
            </x-responsive-nav-link>
